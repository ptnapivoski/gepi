...
// Se logado
if($_SESSION['user']){
	// Pessoa à qual adicionar uso de serviço de mobilidade urbana
	$id = (int) $_POST['id'];
	...
	if($db_link){
		...
		if(perm($db_link, 'permissao_e_entidade', 104, $id)){
			...
			// Tenta inserir
			if($db_query = mysqli_query($db_link, "INSERT INTO pessoa_fisica_e_servico_de_mob (pessoa_fisica, uso) VALUES ($id, $servico);")){
