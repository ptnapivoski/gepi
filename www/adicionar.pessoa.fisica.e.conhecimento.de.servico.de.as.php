...
// Se logado
if($_SESSION['user']){
	// Pessoa à qual adicionar conhecimento de serviço de assitência social
	$id = (int) $_POST['id'];
	...
	if($db_link){
		...
		if(perm($db_link, 'permissao_e_entidade', 78, $id)){
			...
			// Tenta inserir
			if($db_query = mysqli_query($db_link, "INSERT INTO pessoa_fisica_e_conhecimento_de_servico_de_as (pessoa_fisica, conhecimento) VALUES ($id, $servico);")){
