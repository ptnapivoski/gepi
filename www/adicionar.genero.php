		...
		if(perm($db_link, 'permissao_e_genero', 1, NULL)){
			...
			if($db_query = mysqli_query($db_link, "INSERT INTO genero (nome) VALUES ($nome);")){
				...
				if(mysqli_affected_rows($db_link) === 1){
					...
					mysqli_query($db_link, "INSERT INTO permissao_e_genero VALUES ($_SESSION[user], TRUE, 2, $n),($_SESSION[user], TRUE, 3, $n);");
