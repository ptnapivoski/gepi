...
if($_SESSION['user']){
	...
	if($db_link){
		...
		if(perm($db_link, 'permissao_e_tecnologia', 88, NULL)){
			...
			if($db_query = mysqli_query($db_link, "INSERT INTO tecnologia (nome) VALUES ($nome);")){
				...
				if(mysqli_affected_rows($db_link) === 1){
					...
					mysqli_query($db_link, "INSERT INTO permissao_e_tecnologia VALUES ($_SESSION[user], TRUE, 89, $n),($_SESSION[user], TRUE, 90, $n);");
