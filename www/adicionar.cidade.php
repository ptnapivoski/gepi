		...
		if(perm($db_link, 'permissao_e_uf', 37, $id)){
			...
			if($db_query = mysqli_query($db_link, "INSERT INTO cidade (uf, nome) VALUES ($id, $nome);")){
				...
				if(mysqli_affected_rows($db_link) === 1){
					...
					mysqli_query($db_link, "INSERT INTO permissao_e_cidade VALUES ($_SESSION[user], TRUE, 38, $n),($_SESSION[user], TRUE, 39, $n);");
