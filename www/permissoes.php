	...
	if($db_link){
		...
		if(perm($db_link, 'permissao_e_entidade', 87, NULL)){
			...
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre adaptações arquitetônicas</h1>', $EOL
			;

			// Tenta selecionar as permissões de adaptações arquitetônicas
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_adaptacao_arquitetonica rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN adaptacao_arquitetonica obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.adaptacao.arquitetonica.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (110,111,112) ORDER BY id;")){
				...
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM adaptacao_arquitetonica ORDER BY id;")){
					...
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.adaptacao.arquitetonica.php" method="post" class="new">', $EOL,
								'<input type="number" id="adaptacao-arquitetonica-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="adaptacao-arquitetonica-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
						...
						// Para cada adaptação arquitetônica selecionada
						while($db_result = mysqli_fetch_row($db_query_2)){
							// Valida dados vindos do DB
							$db_result[0] = (int) $db_result[0];
							$db_result[1] = htmlspecialchars($db_result[1]);
			...
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre tipos de serviços</h1>', $EOL
			;

			// Tenta selecionar as permissões de tipos de serviços
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_tipo_de_servico rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN tipo_de_servico obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.tipo.de.servico.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (116) ORDER BY id;")){
				...
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM tipo_de_servico ORDER BY id;")){
					...
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.tipo.de.servico.php" method="post" class="new">', $EOL,
								'<input type="number" id="tipo-de-servico-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="tipo-de-servico-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
			...
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre serviços</h1>', $EOL
			;

			// Tenta selecionar as permissões de serviços
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_servico rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN servico obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.servico.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (117,118) ORDER BY id;")){
				...
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM servico ORDER BY id;")){
					...
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.servico.php" method="post" class="new">', $EOL,
								'<input type="number" id="servico-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="servico-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
			...
			// Fim da seção e exibe permissões sobre serviços de saúde
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre serviços de saúde</h1>', $EOL
			;

			// Tenta selecionar as permissões de serviços de saúde
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_servico_de_saude rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN servico_de_saude obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.servico.de.saude.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			// Tenta selecionar ações
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (94,95,96) ORDER BY id;")){
				// Tenta selecionar serviços de saúde
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM servico_de_saude ORDER BY id;")){
					// Se retornou linhas para as duas consultas
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.servico.de.saude.php" method="post" class="new">', $EOL,
								'<input type="number" id="servico-de-saude-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="servico-de-saude-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
						...
						// Para cada serviços de saúde selecionado
						while($db_result = mysqli_fetch_row($db_query_2)){
							// Valida dados vindos do DB
							$db_result[0] = (int) $db_result[0];
							$db_result[1] = htmlspecialchars($db_result[1]);
			...
			// Fim da seção e exibe permissões sobre serviços de educação
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre serviços de educação</h1>', $EOL
			;

			// Tenta selecionar as permissões de serviços de educação
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_servico_de_educacao rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN servico_de_educacao obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.servico.de.educacao.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			// Tenta selecionar ações
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (97,98,99) ORDER BY id;")){
				// Tenta selecionar serviços de educação
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM servico_de_educacao ORDER BY id;")){
					// Se retornou linhas para as duas consultas
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.servico.de.educacao.php" method="post" class="new">', $EOL,
								'<input type="number" id="servico-de-educacao-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="servico-de-educacao-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
						...
						// Para cada serviços de educação selecionado
						while($db_result = mysqli_fetch_row($db_query_2)){
							// Valida dados vindos do DB
							$db_result[0] = (int) $db_result[0];
							$db_result[1] = htmlspecialchars($db_result[1]);
			...
			// Fim da seção e exibe permissões sobre serviços de mobilidade urbana
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre serviços de mobilidade urbana</h1>', $EOL
			;

			// Tenta selecionar as permissões de mobilidade urbana
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_servico_de_mob rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN servico_de_mob obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.servico.de.mob.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			// Tenta selecionar ações
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (100,101,102) ORDER BY id;")){
				// Tenta selecionar serviços de mobilidade urbana
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM servico_de_mob ORDER BY id;")){
					// Se retornou linhas para as duas consultas
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.servico.de.mob.php" method="post" class="new">', $EOL,
								'<input type="number" id="servico-de-mob-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="servico-de-mob-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
						...
						// Para cada serviço de mobilidade urbana
						while($db_result = mysqli_fetch_row($db_query_2)){
							// Valida dados vindos do DB
							$db_result[0] = (int) $db_result[0];
							$db_result[1] = htmlspecialchars($db_result[1]);
			...
			// Fim da seção e exibe permissões sobre serviços de habitação
			echo
				'</section>', $EOL,
				'<section class="cad">', $EOL,
					'<h1>Permissões sobre serviços de habitação</h1>', $EOL
			;

			// Tenta selecionar as permissões de habitação
			if($db_query = mysqli_query($db_link, "SELECT ent.id, acao.id, obj.id, ent.nome, rel.pode, acao.nome, obj.nome, acao.tem_objeto FROM permissao_e_servico_de_hab rel LEFT JOIN entidade ent ON ent.id = rel.entidade LEFT JOIN acao ON acao.id = rel.acao LEFT JOIN servico_de_hab obj ON obj.id = rel.com ORDER BY ent.id, acao.id, obj.id;")){
				// Caso possua linhas da permissão
				if(mysqli_num_rows($db_query)){
					// Para cada linha
					while($db_result = mysqli_fetch_row($db_query)){
						...
						// Imprime linha
						echo
							'<form action="excluir.permissao.e.servico.de.hab.php" method="post" class="row">', $EOL,
								'<input type="hidden" name="entidade" value="', $db_result[0], '"/>', $EOL,
								'<input type="hidden" name="acao" value="', $db_result[1], '"/>', $EOL,
								'<input type="hidden" name="obj" value="', $db_result[2], '"/>', $EOL,
								'<input type="text" value="', $db_result[3], '" class="name"/>', $EOL,
			...
			// Tenta selecionar ações
			if($db_query_1 = mysqli_query($db_link, "SELECT id, nome FROM acao WHERE id IN (113,114,115) ORDER BY id;")){
				// Tenta selecionar serviços de habitação
				if($db_query_2 = mysqli_query($db_link, "SELECT id, nome FROM servico_de_hab ORDER BY id;")){
					// Se retornou linhas para as duas consultas
					if(mysqli_num_rows($db_query_1) && mysqli_num_rows($db_query_2)){
						// Inicia formulário
						echo
							'<form action="adicionar.permissao.e.servico.de.hab.php" method="post" class="new">', $EOL,
								'<input type="number" id="servico-de-hab-entidade-id" value="0" name="entidade" min="0"/>', $EOL,
								'<input type="text" id="servico-de-hab-entidade-nome" value="Qualquer um"/>', $EOL,
								'<select name="pode">', $EOL,
									'<option value="1">Pode</option>', $EOL,
									'<option value="0">Não pode</option>', $EOL,
								'</select>', $EOL,
						...
						// Para cada serviço de habitação
						while($db_result = mysqli_fetch_row($db_query_2)){
							// Valida dados vindos do DB
							$db_result[0] = (int) $db_result[0];
							$db_result[1] = htmlspecialchars($db_result[1]);
