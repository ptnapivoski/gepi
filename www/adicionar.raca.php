		...
		if(perm($db_link, 'permissao_e_raca', 22, NULL)){
			...
			if($db_query = mysqli_query($db_link, "INSERT INTO raca (nome) VALUES ($nome);")){
				...
				if(mysqli_affected_rows($db_link) === 1){
					...
					mysqli_query($db_link, "INSERT INTO permissao_e_raca VALUES ($_SESSION[user], TRUE, 23, $n),($_SESSION[user], TRUE, 24, $n);");
